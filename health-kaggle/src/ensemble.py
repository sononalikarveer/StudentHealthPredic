...
def main():
    print("Ensembling final models using Stacking (Logistic Regression)...")
    oof_cb = pd.read_csv(OOF_DIR / 'final_oof_catboost.csv')
    oof_lgb = pd.read_csv(OOF_DIR / 'final_oof_lightgbm.csv')
    ...
    submission.to_csv(SUBMISSIONS_DIR / 'submission_advanced.csv', index=False)
    print("Saved final advanced submission to outputs/submissions/submission_advanced.csv")
